...
// anything it can't. The toolbar deliberately keeps its own separate,
// plain GoFontFaceSelector (main.go) rather than sharing this one -
// chrome, not document content, and constructing a second
// SystemFontFaceSelector there would mean a second, redundant host
// font-directory scan for a cosmetic-only benefit.
//
